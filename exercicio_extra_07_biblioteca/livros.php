            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    if (!empty($form_data['btn_cad_livro'])) {
                        ...
                        $controle_cadastro->__set('formData', $form_data);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label class="w-100">
                                            ...
                                            <input type="hidden" name="data_inclusao" value="<?= $data_atual ?>">
                                            <input type="date" name="data_inclusao" value="<?= $data_atual ?>" class="form-control" disabled>
                                        </label>
                                    </div>
                                        ...
                                        <label class="w-100">
                                            ...
                                            <select name="grupo" class="form-select" required>
                                                ...
                                                ?>
                                                    ...
                                                    <option value="<?= $grupo['cod_grupo'] ?>"><?= $grupo['grupo'] ?></option>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="w-100">
                                            ...
                                            <select name="autor" class="form-select" required>
                                                ...
                                                $lista_autor = $controle_visualizar->listaAutor();

                                                foreach ($lista_autor as $autor) {

                                                ?>

                                                    <option value="<?= $autor['cod_autor'] ?>"><?= $autor['autor'] ?></option>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="w-100">
                                            ...
                                            <select name="espirito" class="form-select" required>
                                                ...
                                                $lista_espirito = $controle_visualizar->listaEspirito();

                                                foreach ($lista_espirito as $espirito) {

                                                ?>

                                                    <option value="<?= $espirito['cod_espirito'] ?>"><?= $espirito['espirito'] ?></option>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="w-100">
                                            ...
                                            <select name="editora" class="form-select" required>
                                                ...
                                                $lista_editora = $controle_visualizar->listaEditora();

                                                foreach ($lista_editora as $editora) {

                                                ?>

                                                    <option value="<?= $editora['cod_editora'] ?>"><?= $editora['editora'] ?></option>
